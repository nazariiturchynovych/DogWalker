...
public record SendResetPasswordTokenCommand(string UserEmail, string Link) : IRequest<IResult>
{
    public class Handler : IRequestHandler<SendResetPasswordTokenCommand, IResult>
    {
        ...
        public async Task<IResult> Handle(SendResetPasswordTokenCommand request, CancellationToken cancellationToken)
        {
